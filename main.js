...
function addData() {
  ...
  submitVal("LED_COUNT",val);


  var val1 = document.getElementById("Y").value;

  submitVal("LED_STEP",val1);

  var val2 = document.getElementById("1").value;

  submitVal("flagLDR",val2);
...
function unio() {
    var LED_COUNT = document.getElementById("X").value;
    document.getElementById("x1").innerHTML = LED_COUNT;

    var LED_STEP = document.getElementById("Y").value;
    document.getElementById("y1").innerHTML = LED_STEP;

    var flagLDR = document.getElementById("1").value;
    document.getElementById("LDR").innerHTML = flagLDR;
